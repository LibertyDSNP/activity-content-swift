//
//  ActivityContentTests_ImageLink.swift
...
class ActivityContentTests_ImageLink: XCTestCase {
    ...
    func testBuildWithInvalidJson() {
        let builder = ActivityContent.Builders.Attachments.ImageLink(json: "invalid")
    ...
    func testBuildWithValidJsonInvalidObject() {
        let json = """
            ...
            """
        let builder = ActivityContent.Builders.Attachments.ImageLink(json: json)
